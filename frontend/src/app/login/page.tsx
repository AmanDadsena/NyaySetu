        ...
        <div className="bg-white/70 backdrop-blur-xl py-8 px-4 shadow-2xl shadow-black/5 sm:rounded-3xl sm:px-10 border border-gray-100">
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button 
                type="button"
                onClick={() => alert("Google Sign-In requires OAuth credentials to be configured in the production environment. Please use Email Sign-In for now.")}
              ...
              <button 
                type="button"
                onClick={() => alert("Apple Sign-In requires OAuth credentials to be configured in the production environment. Please use Email Sign-In for now.")}
                className="w-full flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-200 rounded-xl shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
              >
